    ...
    try {
        ...
        tbody.innerHTML = data.map(story => {
            ...
            if (story.status === 'pending') {
                actionsHtml = `<i class="icon approve-icon" title="Duyệt">✓</i> <i class="icon delete-icon" title="Xóa">❌</i>`;
            } else if (story.status === 'published') {
                actionsHtml = `<i class="icon reject-icon" title="Từ chối">🚫</i> <i class="icon delete-icon" title="Xóa">❌</i>`;
            } else { // rejected
                actionsHtml = `<i class="icon approve-icon" title="Duyệt">✓</i> <i class="icon delete-icon" title="Xóa">❌</i>`;
            }
